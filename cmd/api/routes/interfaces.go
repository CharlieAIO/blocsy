...
type SwapsRepo interface {
	...
	GetAllWalletSwaps(ctx context.Context, wallet string, limit int64, offset int64) ([]types.SwapLog, error)
	FindTopTraders(ctx context.Context, token string, limit int64) ([]string, error)
