...
func TestSwapHandler(t *testing.T) {
	...
	tests := []TestCase{
		...
		{Target: 1, Signature: "4MvvtBC8589EWzfWM7oLV9omahn3uqaAU7a3k8Xer4FKoMwfpSL9R2VBAdPtxJVLxwJNqksbp4DJUZZC33nvKou1"},
		{Target: 0, Signature: "2vy8cNnzNxReHeKjz5JxRWJcSEqCcRsYdFtWFoNTorsB2bX17ETXtVci4pDqZktVQNZnFyB7K3dDnv9ewkzsyhAT"},
		{Target: 3, Signature: "aDH8MUnMg34diGmHU5459T8Tpw7XsvAu6ajRaNQuP4DvAAeXcPYK1q9eDoXWRaFkRMMzriXnibAkKroQ461Uixr"},
		{Target: 2, Signature: "4C6rbHs5dZHVNX27Mz1uCZC7TXoq7eFLUUnrtD2SwfgRUQfzcMQsRC2GtbHg1PM6AWptad8S67AicDfnSRnkWQgZ"},
