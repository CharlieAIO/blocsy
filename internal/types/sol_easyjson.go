...
func easyjson791538f0DecodeDefiIntelInternalTypes27(in *jlexer.Lexer, out *AddressTableLookup) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "readonlyIndexes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v66 int
					v66 = int(in.Int())
					out.ReadonlyIndexes = append(out.ReadonlyIndexes, v66)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "writableIndexes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v67 int
					v67 = int(in.Int())
					out.WritableIndexes = append(out.WritableIndexes, v67)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson791538f0EncodeDefiIntelInternalTypes27(out *jwriter.Writer, in AddressTableLookup) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.ReadonlyIndexes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v68, v69 := range in.ReadonlyIndexes {
				if v68 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v69))
	...
	}
	{
		...
		if in.WritableIndexes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v70, v71 := range in.WritableIndexes {
				if v70 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v71))
...
func easyjson791538f0DecodeDefiIntelInternalTypes28(in *jlexer.Lexer, out *AccountKey) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson791538f0EncodeDefiIntelInternalTypes28(out *jwriter.Writer, in AccountKey) {
	out.RawByte('{')
	first := true
	_ = first
	{
